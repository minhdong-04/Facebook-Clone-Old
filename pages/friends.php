...
<head>
    ...
    <link rel="stylesheet" href="https://static.xx.fbcdn.net/rsrc.php/v3/yO/l/0,cross/1p2Z0XUqX6G.css?_nc_x=Ij3Wp8lg5K2" />
    ...
    <style>
        ...
        /* Use theme variables defined in assets/css/theme.css; fall back to light defaults when not provided */
        body {
            margin: 0;
            font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif;
            background: var(--app-page-bg, #f0f2f5);
            color: var(--app-text, #050505);
            padding-top: 56px;
        }
        ...
        .account-popover .acct-menu .see-all-btn:hover { background: var(--app-hover, rgba(0, 0, 0, .05)); border-radius: 8px; }
        ...
        .left-sidebar {
            ...
            /* Friends sidebar tokenization (derive from global theme vars) */
            --friends-sb-pill-hover-bg: var(--app-hover, rgba(0,0,0,0.06));
            --friends-sb-pill-active-bg: var(--app-hover, rgba(0,0,0,0.08));
            --friends-sb-icon-bg: var(--app-icon-bg, #e4e6eb);
            --friends-sb-icon-fg: var(--app-text, #050505);
        }
        .sidebar-title {
            padding: 0 24px;
            font-size: 20px;
        ...
        .sidebar-title .gear {
            width: 36px;
            height: 36px;
            background: var(--friends-sb-icon-bg, var(--app-icon-bg, #e4e6eb));
            border-radius: 50%;
            display: inline-flex;
            align-items: center;
            justify-content: center;
        ...
        .sidebar-title .gear:hover { background: var(--friends-sb-pill-hover-bg, var(--app-hover, #f0f2f5)); }
        .sidebar-title .gear svg { width: 20px; height: 20px; display: block; fill: currentColor; }

        .sidebar-menu {
            margin-top: 8px;
        }
        .left-sidebar .sidebar-menu .menu-item {
            padding: 12px 24px;
            display: flex;
            align-items: center;
            gap: 16px;
            font-size: 17px;
            color: var(--app-text, #1c1e21);
            cursor: pointer;
            border-radius: 10px;
            margin: 0 12px;
        }
        .left-sidebar .sidebar-menu .menu-item:hover { background: var(--friends-sb-pill-hover-bg, var(--app-hover, #f0f2f5)); }
        .left-sidebar .sidebar-menu .menu-item.active {
            font-weight: 700;
            color: var(--app-text, #050505);
            background: var(--friends-sb-pill-active-bg, var(--app-hover, #f0f2f5));
        }
        @supports (color: color-mix(in srgb, black, white)) {
            .left-sidebar {
                /* In dark mode this becomes the solid grey circle seen in the screenshot */
                --friends-sb-icon-bg: color-mix(in srgb, var(--app-text) 18%, var(--app-surface-bg));
                --friends-sb-pill-hover-bg: color-mix(in srgb, var(--app-text) 6%, var(--app-surface-bg));
                --friends-sb-pill-active-bg: color-mix(in srgb, var(--app-text) 10%, var(--app-surface-bg));
            }
        }

        .left-sidebar .sidebar-menu .menu-item .mi-icon {
            width: 36px;
            height: 36px;
            border-radius: 50%;
            display: inline-flex;
            ...
            flex: 0 0 36px;
            background: var(--friends-sb-icon-bg, var(--app-icon-bg, #e4e6eb));
            color: var(--friends-sb-icon-fg, var(--app-text, #050505));
        }
        .left-sidebar .sidebar-menu .menu-item .mi-icon svg { width: 20px; height: 20px; display: block; fill: currentColor; }
        .left-sidebar .sidebar-menu .menu-item.active .mi-icon { background: var(--fb-blue); color: #fff; }

        .left-sidebar .sidebar-menu .menu-item .mi-label { flex: 1; }
        .left-sidebar .sidebar-menu .menu-item .mi-chev { margin-left: auto; opacity: 0.85; color: var(--app-muted, #65676B); }
        .left-sidebar .sidebar-menu .menu-item .mi-chev svg { width: 20px; height: 20px; display: block; fill: currentColor; }

        .main-content {
            flex: 1;
            padding: 100px 200px;
            text-align: center;
            color: var(--app-muted, #606770);
            background: transparent;
        }
        .empty-state {
            margin-top: 60px;
        ...
        .empty-image {
            ...
            /* Theme-aware icon palette (fallbacks use existing app vars) */
            --friends-icon-1: var(--app-icon-bg, #e4e6eb);
            --friends-icon-2: var(--app-muted, #65676B);
            --friends-icon-3: var(--app-text, #050505);
            --friends-icon-bg: var(--app-hover, #f2f2f2);
        }

        /* Prefer relative mixes so light/dark keep similar contrast */
        @supports (color: color-mix(in srgb, black, white)) {
            .empty-image {
                --friends-icon-bg: color-mix(in srgb, var(--app-text) 8%, var(--app-surface-bg));
                --friends-icon-1: color-mix(in srgb, var(--app-text) 18%, var(--app-surface-bg));
                --friends-icon-2: color-mix(in srgb, var(--app-text) 32%, var(--app-surface-bg));
                --friends-icon-3: color-mix(in srgb, var(--app-text) 48%, var(--app-surface-bg));
            }
        }
        ...
        /* Icon tạm (thay bằng ảnh thật nếu muốn) */
        .placeholder-icon {
            width: 36px;
            height: 36px;
            background: var(--app-icon-bg, #ddd);
            border-radius: 50%;
        }
    </style>
</head>
<body>
    ...
    <header class="header">
        ...
        <div class="center-nav-wrap" aria-hidden="false">
            <nav class="center-nav" role="navigation" aria-label="Main">
                ...
                <a class="cnav-item active" href="../pages/friends.php" title="Bạn bè" data-key="friends" aria-current="page">
                                ...
                                <a href="../auth/logout.php" class="menu-item" id="acctBtnLogout">
                                    <div class="icon-wrapper" aria-hidden="true">
                                        <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true">
                                            <path d="M10 17a1 1 0 0 0 1-1v-1h4a1 1 0 0 0 .7-.3l3-3a1 1 0 0 0 0-1.4l-3-3A1 1 0 0 0 15 7h-4V6a1 1 0 0 0-1-1H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h5zm1-4V9h3.6l2 2-2 2H11z" />
                                            <path d="M5 7h4v10H5V7z" opacity=".15" />
                                        </svg>
                                    </div>
                                ...
                                <div class="sec-view" data-view="settings">
                                    <div class="sub-menu-list">
                                        ...
                                        <a href="#" class="sub-menu-item" aria-disabled="true">
                                            <div class="icon-wrapper" aria-hidden="true">
                                                <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true">
                                                    <path d="M12 2l7 4v6c0 5-3.5 9.74-7 10-3.5-.26-7-5-7-10V6l7-4zm0 2.3L7 6v6c0 3.96 2.52 7.7 5 7.98 2.48-.28 5-4.02 5-7.98V6l-5-1.7zm-1 11.2l-2.3-2.3a1 1 0 1 1 1.4-1.4l.9.9 2.7-2.7a1 1 0 1 1 1.4 1.4l-4.1 4.1z" />
                                                </svg>
                                            </div>
    ...
    <div class="container">
        ...
        <div class="left-sidebar">
            <div class="sidebar-title">
                Bạn bè
                <div class="gear" role="button" tabindex="0" aria-label="Cài đặt">
            ...
            <div class="sidebar-menu">
                <div class="menu-item active">
                    <div class="mi-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
                            <path d="M16 11c1.66 0 3-1.57 3-3.5S17.66 4 16 4s-3 1.57-3 3.5S14.34 11 16 11zM8 12c1.66 0 3-1.57 3-3.5S9.66 5 8 5s-3 1.57-3 3.5S6.34 12 8 12zm0 2c-2.33 0-7 1.17-7 3.5V20h10v-2.5C11 15.17 10.33 14 8 14zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V20h7v-2.5c0-2.33-4.67-3.5-7-3.5z" />
                        </svg>
                    </div>
                    <div class="mi-label">Trang chủ</div>
                </div>
                <div class="menu-item">
                    <div class="mi-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
                    ...
                    <div class="mi-label">Lời mời kết bạn</div>
                    <div class="mi-chev" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z" /></svg></div>
                </div>
                <div class="menu-item">
                    <div class="mi-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
                            <path d="M12 12c2.21 0 4-1.79 4-4S14.21 4 12 4 8 5.79 8 8s1.79 4 4 4zm6 2h-2v-2h-2v2h-2v2h2v2h2v-2h2v-2zM12 14c-2.67 0-8 1.34-8 4v2h8.2c-.13-.34-.2-.7-.2-1.1V18c0-1.66 1.34-3 3-3h3.35c-1.52-.64-3.61-1-6.35-1z" />
                        </svg>
                    </div>
                    <div class="mi-label">Gợi ý</div>
                    <div class="mi-chev" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z" /></svg></div>
                </div>
                <div class="menu-item">
                    <div class="mi-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
                            <path d="M16 11c1.66 0 3-1.57 3-3.5S17.66 4 16 4s-3 1.57-3 3.5S14.34 11 16 11zM8 12c1.66 0 3-1.57 3-3.5S9.66 5 8 5s-3 1.57-3 3.5S6.34 12 8 12zm0 2c-2.33 0-7 1.17-7 3.5V20h10v-2.5C11 15.17 10.33 14 8 14zm8 0c-2.33 0-7 1.17-7 3.5V20h14v-2.5C23 15.17 18.33 14 16 14z" />
                        </svg>
                    </div>
                    <div class="mi-label">Tất cả bạn bè</div>
                    <div class="mi-chev" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z" /></svg></div>
                </div>
                <div class="menu-item">
                    <div class="mi-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
                            <path d="M20 7h-1.1c.06-.32.1-.65.1-1 0-1.66-1.34-3-3-3-1.07 0-2.01.56-2.54 1.4C12.93 3.56 11.99 3 10.92 3 9.26 3 7.92 4.34 7.92 6c0 .35.04.68.1 1H7c-1.1 0-2 .9-2 2v3h16V9c0-1.1-.9-2-2-2zm-4-2c.55 0 1 .45 1 1s-.45 1-1 1h-2V6c0-.55.45-1 1-1zM10.92 5c.55 0 1 .45 1 1v2h-2c-.55 0-1-.45-1-1s.45-1 1-1zM5 14v7c0 1.1.9 2 2 2h3v-9H5zm7 0v9h3c1.1 0 2-.9 2-2v-7h-5zm7 0v7c0 1.1-.9 2-2 2h-1v-9h3z" />
                        </svg>
                    </div>
                    <div class="mi-label">Sinh nhật</div>
                </div>
                <div class="menu-item">
                    <div class="mi-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
                    ...
                    <div class="mi-label">Danh sách tùy chỉnh</div>
                    <div class="mi-chev" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M10 6 8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z" /></svg></div>
                </div>
            </div>
        </div>
        ...
        <div class="main-content">
            <div class="empty-state">
                <div class="empty-image">
                    <!-- Inline icon (no external image dependency) -->
                    <svg viewBox="0 0 112 112" width="112" height="112" aria-hidden="true" focusable="false">
                        <defs>
                            <clipPath id="friendsEmptyClip">
                                <circle cx="72.58" cy="53.81" r="12.08" />
                            </clipPath>
                        </defs>

                        <!-- small badge (top-right) -->
                        <g clip-path="url(#friendsEmptyClip)">
                            <circle cx="72.58" cy="53.81" r="12.08" fill="var(--fb-blue)" />
                            <circle cx="62.18" cy="40.55" r="14.72" fill="var(--friends-icon-1)" />
                            <circle cx="88.92" cy="39.27" r="14.72" fill="var(--friends-icon-1)" />
                        </g>

                        <!-- left person -->
                        <path fill="var(--friends-icon-2)" d="M27.37 17.56h11.3a3.84 3.84 0 0 1 3.84 3.84v15h-19v-15a3.84 3.84 0 0 1 3.86-3.84z" />
                        <rect width="19" height="24.75" x="23.52" y="26.9" rx="8.65" fill="var(--friends-icon-bg)" />
                        <path fill="var(--friends-icon-1)" d="M18.87 55.28h28.3a7 7 0 0 1 7 7v37.36H11.92V62.23a7 7 0 0 1 6.95-6.95z" />

                        <!-- right person -->
                        <path fill="var(--friends-icon-3)" d="M68.63 68.28h5.06A26.12 26.12 0 0 1 99.8 94.4v5.25H42.51V94.4a26.12 26.12 0 0 1 26.12-26.12z" />
                        <circle cx="66.32" cy="35.2" r="7.55" fill="var(--friends-icon-2)" />
                    </svg>
                </div>
    ...
    <!-- Shared nav behaviors (account popover + messenger with data) -->
    ...
    <script>
        (function () {
            // Wire theme selector (Tắt/Bật/Tự động) to the existing theme system
            const KEY = 'fbmenu-theme';
            const rows = Array.from(document.querySelectorAll('.radio-row[data-group="darkmode"]'));
            if (!rows.length) return;

            const applySelected = () => {
                let v = 'off';
                try { v = localStorage.getItem(KEY) || 'off'; } catch (_e) { v = 'off'; }
                rows.forEach((r) => r.classList.toggle('selected', (r.dataset.value || 'off') === v));
            };

            const applyThemeAttr = (v) => {
                const theme = (v === 'on') ? 'dark' : (v === 'auto' ? 'auto' : 'light');
                try { document.documentElement.setAttribute('data-theme', theme); } catch (_e) {}
                try { document.body && document.body.setAttribute('data-theme', theme); } catch (_e) {}
            };

            rows.forEach((r) => {
                r.addEventListener('click', () => {
                    const v = (r.dataset.value || 'off');
